...
class Budget {
     ...
     * (You should not understand the if statements, just that we output income tax from this method)
    */
    ...
    /* Calculate how much to allocate to a monthly budget category given a percentage of take-home pay */
